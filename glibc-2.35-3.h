...
__asm__(".symver _Fork _Fork@GLIBC_2.34")
...
__asm__(".symver __isnanf128 __isnanf128@GLIBC_2.34")
...
__asm__(".symver __memcmpeq __memcmpeq@GLIBC_2.35")
...
__asm__(".symver __mq_open_2 __mq_open_2@GLIBC_2.34")
...
__asm__(".symver __pthread_cleanup_routine __pthread_cleanup_routine@GLIBC_2.34")
...
__asm__(".symver __pthread_register_cancel __pthread_register_cancel@GLIBC_2.34")
__asm__(".symver __pthread_register_cancel_defer __pthread_register_cancel_defer@GLIBC_2.34")
...
__asm__(".symver __pthread_unregister_cancel __pthread_unregister_cancel@GLIBC_2.34")
__asm__(".symver __pthread_unregister_cancel_restore __pthread_unregister_cancel_restore@GLIBC_2.34")
__asm__(".symver __pthread_unwind_next __pthread_unwind_next@GLIBC_2.34")
...
__asm__(".symver __x86_get_cpuid_feature_leaf __x86_get_cpuid_feature_leaf@GLIBC_2.33")
...
__asm__(".symver _dl_find_object _dl_find_object@GLIBC_2.35")
...
__asm__(".symver _pthread_cleanup_pop _pthread_cleanup_pop@GLIBC_2.34")
__asm__(".symver _pthread_cleanup_pop_restore _pthread_cleanup_pop_restore@GLIBC_2.2.5")
__asm__(".symver _pthread_cleanup_push _pthread_cleanup_push@GLIBC_2.34")
...
__asm__(".symver aio_cancel aio_cancel@GLIBC_2.34")
__asm__(".symver aio_cancel64 aio_cancel64@GLIBC_2.34")
__asm__(".symver aio_error aio_error@GLIBC_2.34")
__asm__(".symver aio_error64 aio_error64@GLIBC_2.34")
__asm__(".symver aio_fsync aio_fsync@GLIBC_2.34")
__asm__(".symver aio_fsync64 aio_fsync64@GLIBC_2.34")
__asm__(".symver aio_init aio_init@GLIBC_2.34")
__asm__(".symver aio_read aio_read@GLIBC_2.34")
__asm__(".symver aio_read64 aio_read64@GLIBC_2.34")
__asm__(".symver aio_return aio_return@GLIBC_2.34")
__asm__(".symver aio_return64 aio_return64@GLIBC_2.34")
__asm__(".symver aio_suspend aio_suspend@GLIBC_2.34")
__asm__(".symver aio_suspend64 aio_suspend64@GLIBC_2.34")
__asm__(".symver aio_write aio_write@GLIBC_2.34")
__asm__(".symver aio_write64 aio_write64@GLIBC_2.34")
...
__asm__(".symver call_once call_once@GLIBC_2.34")
...
__asm__(".symver close_range close_range@GLIBC_2.34")
__asm__(".symver closedir closedir@GLIBC_2.2.5")
__asm__(".symver closefrom closefrom@GLIBC_2.34")
__asm__(".symver closelog closelog@GLIBC_2.2.5")
__asm__(".symver cnd_broadcast cnd_broadcast@GLIBC_2.34")
__asm__(".symver cnd_destroy cnd_destroy@GLIBC_2.34")
__asm__(".symver cnd_init cnd_init@GLIBC_2.34")
__asm__(".symver cnd_signal cnd_signal@GLIBC_2.34")
__asm__(".symver cnd_timedwait cnd_timedwait@GLIBC_2.34")
__asm__(".symver cnd_wait cnd_wait@GLIBC_2.34")
...
__asm__(".symver dladdr dladdr@GLIBC_2.34")
__asm__(".symver dladdr1 dladdr1@GLIBC_2.34")
__asm__(".symver dlclose dlclose@GLIBC_2.34")
__asm__(".symver dlerror dlerror@GLIBC_2.34")
__asm__(".symver dlinfo dlinfo@GLIBC_2.34")
__asm__(".symver dlmopen dlmopen@GLIBC_2.34")
__asm__(".symver dlopen dlopen@GLIBC_2.34")
__asm__(".symver dlsym dlsym@GLIBC_2.34")
__asm__(".symver dlvsym dlvsym@GLIBC_2.34")
__asm__(".symver dn_comp dn_comp@GLIBC_2.34")
__asm__(".symver dn_expand dn_expand@GLIBC_2.34")
__asm__(".symver dn_skipname dn_skipname@GLIBC_2.34")
...
__asm__(".symver epoll_pwait2 epoll_pwait2@GLIBC_2.35")
...
__asm__(".symver execveat execveat@GLIBC_2.34")
...
__asm__(".symver forkpty forkpty@GLIBC_2.34")
...
__asm__(".symver fstat64 fstat64@GLIBC_2.33")
__asm__(".symver fstatat fstatat@GLIBC_2.33")
__asm__(".symver fstatat64 fstatat64@GLIBC_2.33")
...
__asm__(".symver gai_cancel gai_cancel@GLIBC_2.34")
__asm__(".symver gai_error gai_error@GLIBC_2.34")
__asm__(".symver gai_strerror gai_strerror@GLIBC_2.2.5")
__asm__(".symver gai_suspend gai_suspend@GLIBC_2.34")
...
__asm__(".symver getaddrinfo_a getaddrinfo_a@GLIBC_2.34")
...
__asm__(".symver glob glob@GLIBC_2.27")
__asm__(".symver glob64 glob64@GLIBC_2.27")
...
__asm__(".symver lio_listio lio_listio@GLIBC_2.34")
__asm__(".symver lio_listio64 lio_listio64@GLIBC_2.34")
...
__asm__(".symver login login@GLIBC_2.34")
__asm__(".symver login_tty login_tty@GLIBC_2.34")
__asm__(".symver logout logout@GLIBC_2.34")
__asm__(".symver logwtmp logwtmp@GLIBC_2.34")
...
__asm__(".symver lstat lstat@GLIBC_2.33")
__asm__(".symver lstat64 lstat64@GLIBC_2.33")
...
__asm__(".symver mallinfo2 mallinfo2@GLIBC_2.33")
...
__asm__(".symver memfd_create memfd_create@GLIBC_2.27")
...
__asm__(".symver mknod mknod@GLIBC_2.33")
__asm__(".symver mknodat mknodat@GLIBC_2.33")
...
__asm__(".symver mlock2 mlock2@GLIBC_2.27")
...
__asm__(".symver mq_close mq_close@GLIBC_2.34")
__asm__(".symver mq_getattr mq_getattr@GLIBC_2.34")
__asm__(".symver mq_notify mq_notify@GLIBC_2.34")
__asm__(".symver mq_open mq_open@GLIBC_2.34")
__asm__(".symver mq_receive mq_receive@GLIBC_2.34")
__asm__(".symver mq_send mq_send@GLIBC_2.34")
__asm__(".symver mq_setattr mq_setattr@GLIBC_2.34")
__asm__(".symver mq_timedreceive mq_timedreceive@GLIBC_2.34")
__asm__(".symver mq_timedsend mq_timedsend@GLIBC_2.34")
__asm__(".symver mq_unlink mq_unlink@GLIBC_2.34")
...
__asm__(".symver mtx_destroy mtx_destroy@GLIBC_2.34")
__asm__(".symver mtx_init mtx_init@GLIBC_2.34")
__asm__(".symver mtx_lock mtx_lock@GLIBC_2.34")
__asm__(".symver mtx_timedlock mtx_timedlock@GLIBC_2.34")
__asm__(".symver mtx_trylock mtx_trylock@GLIBC_2.34")
__asm__(".symver mtx_unlock mtx_unlock@GLIBC_2.34")
...
__asm__(".symver ns_name_compress ns_name_compress@GLIBC_2.34")
__asm__(".symver ns_name_ntop ns_name_ntop@GLIBC_2.34")
__asm__(".symver ns_name_pack ns_name_pack@GLIBC_2.34")
__asm__(".symver ns_name_pton ns_name_pton@GLIBC_2.34")
__asm__(".symver ns_name_skip ns_name_skip@GLIBC_2.34")
__asm__(".symver ns_name_uncompress ns_name_uncompress@GLIBC_2.34")
__asm__(".symver ns_name_unpack ns_name_unpack@GLIBC_2.34")
...
__asm__(".symver openpty openpty@GLIBC_2.34")
...
__asm__(".symver pkey_alloc pkey_alloc@GLIBC_2.27")
__asm__(".symver pkey_free pkey_free@GLIBC_2.27")
__asm__(".symver pkey_get pkey_get@GLIBC_2.27")
__asm__(".symver pkey_mprotect pkey_mprotect@GLIBC_2.27")
__asm__(".symver pkey_set pkey_set@GLIBC_2.27")
...
__asm__(".symver posix_spawn_file_actions_addchdir_np posix_spawn_file_actions_addchdir_np@GLIBC_2.29")
__asm__(".symver posix_spawn_file_actions_addclose posix_spawn_file_actions_addclose@GLIBC_2.2.5")
__asm__(".symver posix_spawn_file_actions_addclosefrom_np posix_spawn_file_actions_addclosefrom_np@GLIBC_2.34")
__asm__(".symver posix_spawn_file_actions_adddup2 posix_spawn_file_actions_adddup2@GLIBC_2.2.5")
__asm__(".symver posix_spawn_file_actions_addfchdir_np posix_spawn_file_actions_addfchdir_np@GLIBC_2.29")
__asm__(".symver posix_spawn_file_actions_addopen posix_spawn_file_actions_addopen@GLIBC_2.2.5")
__asm__(".symver posix_spawn_file_actions_addtcsetpgrp_np posix_spawn_file_actions_addtcsetpgrp_np@GLIBC_2.35")
...
__asm__(".symver preadv2 preadv2@GLIBC_2.26")
__asm__(".symver preadv64 preadv64@GLIBC_2.10")
__asm__(".symver preadv64v2 preadv64v2@GLIBC_2.26")
...
__asm__(".symver pthread_attr_getaffinity_np pthread_attr_getaffinity_np@GLIBC_2.34")
__asm__(".symver pthread_attr_getdetachstate pthread_attr_getdetachstate@GLIBC_2.2.5")
__asm__(".symver pthread_attr_getguardsize pthread_attr_getguardsize@GLIBC_2.34")
...
__asm__(".symver pthread_attr_getstack pthread_attr_getstack@GLIBC_2.34")
__asm__(".symver pthread_attr_getstackaddr pthread_attr_getstackaddr@GLIBC_2.34")
__asm__(".symver pthread_attr_getstacksize pthread_attr_getstacksize@GLIBC_2.34")
__asm__(".symver pthread_attr_init pthread_attr_init@GLIBC_2.2.5")
__asm__(".symver pthread_attr_setaffinity_np pthread_attr_setaffinity_np@GLIBC_2.32")
__asm__(".symver pthread_attr_setdetachstate pthread_attr_setdetachstate@GLIBC_2.2.5")
__asm__(".symver pthread_attr_setguardsize pthread_attr_setguardsize@GLIBC_2.34")
...
__asm__(".symver pthread_attr_setstack pthread_attr_setstack@GLIBC_2.34")
__asm__(".symver pthread_attr_setstackaddr pthread_attr_setstackaddr@GLIBC_2.34")
__asm__(".symver pthread_attr_setstacksize pthread_attr_setstacksize@GLIBC_2.34")
__asm__(".symver pthread_barrier_destroy pthread_barrier_destroy@GLIBC_2.34")
__asm__(".symver pthread_barrier_init pthread_barrier_init@GLIBC_2.34")
__asm__(".symver pthread_barrier_wait pthread_barrier_wait@GLIBC_2.34")
__asm__(".symver pthread_barrierattr_destroy pthread_barrierattr_destroy@GLIBC_2.34")
__asm__(".symver pthread_barrierattr_getpshared pthread_barrierattr_getpshared@GLIBC_2.34")
__asm__(".symver pthread_barrierattr_init pthread_barrierattr_init@GLIBC_2.34")
__asm__(".symver pthread_barrierattr_setpshared pthread_barrierattr_setpshared@GLIBC_2.34")
__asm__(".symver pthread_cancel pthread_cancel@GLIBC_2.34")
__asm__(".symver pthread_clockjoin_np pthread_clockjoin_np@GLIBC_2.34")
__asm__(".symver pthread_cond_broadcast pthread_cond_broadcast@GLIBC_2.3.2")
__asm__(".symver pthread_cond_clockwait pthread_cond_clockwait@GLIBC_2.34")
...
__asm__(".symver pthread_condattr_getclock pthread_condattr_getclock@GLIBC_2.34")
__asm__(".symver pthread_condattr_getpshared pthread_condattr_getpshared@GLIBC_2.34")
__asm__(".symver pthread_condattr_init pthread_condattr_init@GLIBC_2.2.5")
__asm__(".symver pthread_condattr_setclock pthread_condattr_setclock@GLIBC_2.34")
__asm__(".symver pthread_condattr_setpshared pthread_condattr_setpshared@GLIBC_2.34")
__asm__(".symver pthread_create pthread_create@GLIBC_2.34")
__asm__(".symver pthread_detach pthread_detach@GLIBC_2.34")
__asm__(".symver pthread_equal pthread_equal@GLIBC_2.2.5")
__asm__(".symver pthread_exit pthread_exit@GLIBC_2.2.5")
__asm__(".symver pthread_getaffinity_np pthread_getaffinity_np@GLIBC_2.32")
__asm__(".symver pthread_getattr_default_np pthread_getattr_default_np@GLIBC_2.34")
__asm__(".symver pthread_getattr_np pthread_getattr_np@GLIBC_2.32")
__asm__(".symver pthread_getconcurrency pthread_getconcurrency@GLIBC_2.34")
__asm__(".symver pthread_getcpuclockid pthread_getcpuclockid@GLIBC_2.34")
__asm__(".symver pthread_getname_np pthread_getname_np@GLIBC_2.34")
__asm__(".symver pthread_getschedparam pthread_getschedparam@GLIBC_2.2.5")
__asm__(".symver pthread_getspecific pthread_getspecific@GLIBC_2.34")
__asm__(".symver pthread_join pthread_join@GLIBC_2.34")
__asm__(".symver pthread_key_create pthread_key_create@GLIBC_2.34")
__asm__(".symver pthread_key_delete pthread_key_delete@GLIBC_2.34")
__asm__(".symver pthread_kill pthread_kill@GLIBC_2.34")
__asm__(".symver pthread_kill_other_threads_np pthread_kill_other_threads_np@GLIBC_2.2.5")
__asm__(".symver pthread_mutex_clocklock pthread_mutex_clocklock@GLIBC_2.34")
__asm__(".symver pthread_mutex_consistent pthread_mutex_consistent@GLIBC_2.34")
...
__asm__(".symver pthread_mutex_getprioceiling pthread_mutex_getprioceiling@GLIBC_2.34")
...
__asm__(".symver pthread_mutex_setprioceiling pthread_mutex_setprioceiling@GLIBC_2.34")
__asm__(".symver pthread_mutex_timedlock pthread_mutex_timedlock@GLIBC_2.34")
__asm__(".symver pthread_mutex_trylock pthread_mutex_trylock@GLIBC_2.34")
__asm__(".symver pthread_mutex_unlock pthread_mutex_unlock@GLIBC_2.2.5")
__asm__(".symver pthread_mutexattr_destroy pthread_mutexattr_destroy@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_getkind_np pthread_mutexattr_getkind_np@GLIBC_2.2.5")
__asm__(".symver pthread_mutexattr_getprioceiling pthread_mutexattr_getprioceiling@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_getprotocol pthread_mutexattr_getprotocol@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_getpshared pthread_mutexattr_getpshared@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_getrobust pthread_mutexattr_getrobust@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_getrobust_np pthread_mutexattr_getrobust_np@GLIBC_2.4")
__asm__(".symver pthread_mutexattr_gettype pthread_mutexattr_gettype@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_init pthread_mutexattr_init@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_setkind_np pthread_mutexattr_setkind_np@GLIBC_2.2.5")
__asm__(".symver pthread_mutexattr_setprioceiling pthread_mutexattr_setprioceiling@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_setprotocol pthread_mutexattr_setprotocol@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_setpshared pthread_mutexattr_setpshared@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_setrobust pthread_mutexattr_setrobust@GLIBC_2.34")
__asm__(".symver pthread_mutexattr_setrobust_np pthread_mutexattr_setrobust_np@GLIBC_2.4")
__asm__(".symver pthread_mutexattr_settype pthread_mutexattr_settype@GLIBC_2.34")
__asm__(".symver pthread_once pthread_once@GLIBC_2.34")
__asm__(".symver pthread_rwlock_clockrdlock pthread_rwlock_clockrdlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_clockwrlock pthread_rwlock_clockwrlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_destroy pthread_rwlock_destroy@GLIBC_2.34")
__asm__(".symver pthread_rwlock_init pthread_rwlock_init@GLIBC_2.34")
__asm__(".symver pthread_rwlock_rdlock pthread_rwlock_rdlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_timedrdlock pthread_rwlock_timedrdlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_timedwrlock pthread_rwlock_timedwrlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_tryrdlock pthread_rwlock_tryrdlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_trywrlock pthread_rwlock_trywrlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_unlock pthread_rwlock_unlock@GLIBC_2.34")
__asm__(".symver pthread_rwlock_wrlock pthread_rwlock_wrlock@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_destroy pthread_rwlockattr_destroy@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_getkind_np pthread_rwlockattr_getkind_np@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_getpshared pthread_rwlockattr_getpshared@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_init pthread_rwlockattr_init@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_setkind_np pthread_rwlockattr_setkind_np@GLIBC_2.34")
__asm__(".symver pthread_rwlockattr_setpshared pthread_rwlockattr_setpshared@GLIBC_2.34")
__asm__(".symver pthread_self pthread_self@GLIBC_2.2.5")
__asm__(".symver pthread_setaffinity_np pthread_setaffinity_np@GLIBC_2.34")
__asm__(".symver pthread_setattr_default_np pthread_setattr_default_np@GLIBC_2.34")
...
__asm__(".symver pthread_setconcurrency pthread_setconcurrency@GLIBC_2.34")
__asm__(".symver pthread_setname_np pthread_setname_np@GLIBC_2.34")
__asm__(".symver pthread_setschedparam pthread_setschedparam@GLIBC_2.2.5")
__asm__(".symver pthread_setschedprio pthread_setschedprio@GLIBC_2.34")
__asm__(".symver pthread_setspecific pthread_setspecific@GLIBC_2.34")
__asm__(".symver pthread_sigmask pthread_sigmask@GLIBC_2.32")
__asm__(".symver pthread_sigqueue pthread_sigqueue@GLIBC_2.34")
__asm__(".symver pthread_spin_destroy pthread_spin_destroy@GLIBC_2.34")
__asm__(".symver pthread_spin_init pthread_spin_init@GLIBC_2.34")
__asm__(".symver pthread_spin_lock pthread_spin_lock@GLIBC_2.34")
__asm__(".symver pthread_spin_trylock pthread_spin_trylock@GLIBC_2.34")
__asm__(".symver pthread_spin_unlock pthread_spin_unlock@GLIBC_2.34")
__asm__(".symver pthread_testcancel pthread_testcancel@GLIBC_2.34")
__asm__(".symver pthread_timedjoin_np pthread_timedjoin_np@GLIBC_2.34")
__asm__(".symver pthread_tryjoin_np pthread_tryjoin_np@GLIBC_2.34")
...
__asm__(".symver pwritev2 pwritev2@GLIBC_2.26")
__asm__(".symver pwritev64 pwritev64@GLIBC_2.10")
__asm__(".symver pwritev64v2 pwritev64v2@GLIBC_2.26")
...
__asm__(".symver quick_exit quick_exit@GLIBC_2.24")
...
__asm__(".symver renameat2 renameat2@GLIBC_2.28")
__asm__(".symver res_dnok res_dnok@GLIBC_2.34")
__asm__(".symver res_hnok res_hnok@GLIBC_2.34")
__asm__(".symver res_mailok res_mailok@GLIBC_2.34")
__asm__(".symver res_mkquery res_mkquery@GLIBC_2.34")
__asm__(".symver res_nmkquery res_nmkquery@GLIBC_2.34")
__asm__(".symver res_nquery res_nquery@GLIBC_2.34")
__asm__(".symver res_nquerydomain res_nquerydomain@GLIBC_2.34")
__asm__(".symver res_nsearch res_nsearch@GLIBC_2.34")
__asm__(".symver res_nsend res_nsend@GLIBC_2.34")
__asm__(".symver res_ownok res_ownok@GLIBC_2.34")
__asm__(".symver res_query res_query@GLIBC_2.34")
__asm__(".symver res_querydomain res_querydomain@GLIBC_2.34")
__asm__(".symver res_search res_search@GLIBC_2.34")
__asm__(".symver res_send res_send@GLIBC_2.34")
...
__asm__(".symver sem_clockwait sem_clockwait@GLIBC_2.34")
__asm__(".symver sem_close sem_close@GLIBC_2.34")
__asm__(".symver sem_destroy sem_destroy@GLIBC_2.34")
__asm__(".symver sem_getvalue sem_getvalue@GLIBC_2.34")
__asm__(".symver sem_init sem_init@GLIBC_2.34")
__asm__(".symver sem_open sem_open@GLIBC_2.34")
__asm__(".symver sem_post sem_post@GLIBC_2.34")
__asm__(".symver sem_timedwait sem_timedwait@GLIBC_2.34")
__asm__(".symver sem_trywait sem_trywait@GLIBC_2.34")
__asm__(".symver sem_unlink sem_unlink@GLIBC_2.34")
__asm__(".symver sem_wait sem_wait@GLIBC_2.34")
...
__asm__(".symver shm_open shm_open@GLIBC_2.34")
__asm__(".symver shm_unlink shm_unlink@GLIBC_2.34")
...
__asm__(".symver sigabbrev_np sigabbrev_np@GLIBC_2.32")
...
__asm__(".symver sigdescr_np sigdescr_np@GLIBC_2.32")
...
__asm__(".symver strerrordesc_np strerrordesc_np@GLIBC_2.32")
__asm__(".symver strerrorname_np strerrorname_np@GLIBC_2.32")
__asm__(".symver strfmon strfmon@GLIBC_2.2.5")
__asm__(".symver strfmon_l strfmon_l@GLIBC_2.3")
__asm__(".symver strfromd strfromd@GLIBC_2.25")
__asm__(".symver strfromf strfromf@GLIBC_2.25")
__asm__(".symver strfromf128 strfromf128@GLIBC_2.26")
__asm__(".symver strfromf32 strfromf32@GLIBC_2.27")
__asm__(".symver strfromf32x strfromf32x@GLIBC_2.27")
__asm__(".symver strfromf64 strfromf64@GLIBC_2.27")
__asm__(".symver strfromf64x strfromf64x@GLIBC_2.27")
__asm__(".symver strfroml strfroml@GLIBC_2.25")
...
__asm__(".symver strtof128 strtof128@GLIBC_2.26")
__asm__(".symver strtof128_l strtof128_l@GLIBC_2.26")
__asm__(".symver strtof32 strtof32@GLIBC_2.27")
__asm__(".symver strtof32_l strtof32_l@GLIBC_2.27")
__asm__(".symver strtof32x strtof32x@GLIBC_2.27")
__asm__(".symver strtof32x_l strtof32x_l@GLIBC_2.27")
__asm__(".symver strtof64 strtof64@GLIBC_2.27")
__asm__(".symver strtof64_l strtof64_l@GLIBC_2.27")
__asm__(".symver strtof64x strtof64x@GLIBC_2.27")
__asm__(".symver strtof64x_l strtof64x_l@GLIBC_2.27")
...
__asm__(".symver tgkill tgkill@GLIBC_2.30")
__asm__(".symver thrd_create thrd_create@GLIBC_2.34")
__asm__(".symver thrd_current thrd_current@GLIBC_2.28")
__asm__(".symver thrd_detach thrd_detach@GLIBC_2.34")
__asm__(".symver thrd_equal thrd_equal@GLIBC_2.28")
__asm__(".symver thrd_exit thrd_exit@GLIBC_2.34")
__asm__(".symver thrd_join thrd_join@GLIBC_2.34")
__asm__(".symver thrd_sleep thrd_sleep@GLIBC_2.28")
__asm__(".symver thrd_yield thrd_yield@GLIBC_2.28")
...
__asm__(".symver timer_create timer_create@GLIBC_2.34")
__asm__(".symver timer_delete timer_delete@GLIBC_2.34")
__asm__(".symver timer_getoverrun timer_getoverrun@GLIBC_2.34")
__asm__(".symver timer_gettime timer_gettime@GLIBC_2.34")
__asm__(".symver timer_settime timer_settime@GLIBC_2.34")
...
__asm__(".symver timespec_getres timespec_getres@GLIBC_2.34")
...
__asm__(".symver tss_create tss_create@GLIBC_2.34")
__asm__(".symver tss_delete tss_delete@GLIBC_2.34")
__asm__(".symver tss_get tss_get@GLIBC_2.34")
__asm__(".symver tss_set tss_set@GLIBC_2.34")
...
__asm__(".symver twalk_r twalk_r@GLIBC_2.30")
...
__asm__(".symver wcstof128 wcstof128@GLIBC_2.26")
__asm__(".symver wcstof128_l wcstof128_l@GLIBC_2.26")
__asm__(".symver wcstof32 wcstof32@GLIBC_2.27")
__asm__(".symver wcstof32_l wcstof32_l@GLIBC_2.27")
__asm__(".symver wcstof32x wcstof32x@GLIBC_2.27")
__asm__(".symver wcstof32x_l wcstof32x_l@GLIBC_2.27")
__asm__(".symver wcstof64 wcstof64@GLIBC_2.27")
__asm__(".symver wcstof64_l wcstof64_l@GLIBC_2.27")
__asm__(".symver wcstof64x wcstof64x@GLIBC_2.27")
__asm__(".symver wcstof64x_l wcstof64x_l@GLIBC_2.27")
